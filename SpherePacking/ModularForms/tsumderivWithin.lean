...
theorem iter_deriv_comp_bound2 (K : Set ℂ) (hK1 : K ⊆ ℍ') (hK2 : IsCompact K) (k : ℕ) :
  ...
  · use fun n : ℕ => ‖((2 * ↑π * Complex.I * n) ^ (k + 1) * r ^ n)‖, hu
    ...
    simp only [BoundedContinuousFunction.norm_mkOfCompact, Complex.norm_mul, norm_pow, norm_ofNat,
      norm_real, Real.norm_eq_abs, norm_I, mul_one, RCLike.norm_natCast, ge_iff_le] at *
    simp_rw [go]
